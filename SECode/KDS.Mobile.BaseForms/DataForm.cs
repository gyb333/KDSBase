...
namespace KDS.Client.BaseForms
{
    ...
    public class DataForm: BaseForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataEditToolbar1.Location = new System.Drawing.Point(0, 0);
            ...
            this.dataEditToolbar1.Size = new System.Drawing.Size(820, 40);
            this.dataEditToolbar1.TabIndex = 0;
            this.dataEditToolbar1.Text = "dataEditToolbar1";
            this.dataEditToolbar1.UndoEnabled = true;
            this.dataEditToolbar1.UndoVisible = false;
            // 
            // bindingSource1
            // 
        ...
        private void InitControl()
        {
            ...
            this.dataEditToolbar1.UndoClick += new EventHandler(dataEditToolbar1_UndoClick);
        ...
        void dataEditToolbar1_UndoClick(object sender, EventArgs e)
        {
            try
            {
                this.Undo();
        ...
        private void InitButtonStatus()
        {
            ...
            this.dataEditToolbar1.UndoVisible = (this.mDataFormType == 2);
