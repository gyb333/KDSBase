...
namespace KDS.Client.App
{
    ...
    public sealed class ClientGlobalData
    {
        ...
        /// 应用程序名称,huhm2008
        /// </summary>
        public const string AppName = "KDS经销商生意系统";
        ...
        /// </summary>
#if (DEBUG)
        public const bool DebugMode = true;   //编译模式
#else 
        public const bool DebugMode = false;  //Release模式
#endif
        ...
        /// </summary>
#if (DEBUG)
        public static int DataPageSize = 50;   
#else 
        public static int DataPageSize = 500;     //Release模式
#endif
